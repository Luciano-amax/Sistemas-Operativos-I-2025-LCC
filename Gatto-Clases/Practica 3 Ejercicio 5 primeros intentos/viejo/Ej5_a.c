...
que cuenta los lectores que quieren leer.
    Cuando aparece un lector se netre en una pequenia region critica para contar a los lectores,
...
El ultimo lector libera el mutex de lector/escritor. y se repite el proceso.
*/